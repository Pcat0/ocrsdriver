...
@Mod(modid = OCRSDriver.MODID, version = OCRSDriver.VERSION, acceptableRemoteVersions = "*" , dependencies = "required-after:OpenComputers;required-after:refinedstorage")
